    ...
    public partial class Resultados : System.Web.UI.Page
    {
        ...
        public void sendalarma()
        {
            ...
            { 
                ...
                if (ID <= 50)
                {
                    Email.Correo("andres.ponce.de.leon.huerta@gmail.com", 0, "Urge ingresar otros 200 registros.", 3, "aponcedeleon51@hotail.com", "ep1tafi0");
                }
                sqlConn.Close();
            }
        }
        ...
        protected void ibGuardar_Click(object sender, ImageClickEventArgs e)
        {
         ...
         {       
            try
            {
                ...
                Email.Correo(txtEmail.Text, ID, "Pronto nos pondremos en contacto, agradecemos su evaluación. Gracias", 1, "apl_mx@ppenaw.com", "Pru3b4_");
                //sendmail();
                lblW.Visible = true;
